<template>
  <vis-border title="报警趋势" width="124rem" height="42.8rem">
    ...
    initChart() {
      ...
      this.option = {
        ...
        series: [{
          ...
          lineStyle: {
            normal: {
              color: "rgba(0,218,255,1)", // 线条颜色
            },
            borderColor: "rgba(0,218,255,1)"
          },
          itemStyle: {
          ...
          areaStyle: { //区域填充样式
            normal: {
              ...
              color: new echarts.graphic.LinearGradient(0, 0, 0, 1, [{
                  offset: 0,
                  color: "rgba(0,218,255,0.74)"
                },
                {
                  offset: 1,
                  color: "rgba(0,218,255, 0)"
                }
              ], false),
              shadowColor: 'rgba(0,218,255, 0.9)', //阴影颜色
