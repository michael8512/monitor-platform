 ...
 * @LastEditors: hexy
 * @LastEditTime: 2021-05-30 17:03:26
 * @FilePath: /monitor-platform/src/pages/onDuty/component/instrumentPanel.vue
-->
<template>
...
export default {
  ...
  props: {
    ...
    color: {
      type: Array,
      default: ["#137EDD", "#CA0D0D"],
    },
    titleColor: {
      type: Array,
      default: ["#137EDD", "#137EDD"],
    },
    titleFormatter: {
      type: Function,
    ...
    initChart() {
      ...
      var rich = {
        bule: {
          ...
          color: this.titleColor[0],
          fontWeight: "bold",
          padding: [-25, 0, 0, 0],
        },
        radius: {
          fontSize: 1.6 * fontSize,
          color: this.titleColor[1],
          textAlign: "center",
          padding: [-65, 0, 0, 0],
        },
      };
